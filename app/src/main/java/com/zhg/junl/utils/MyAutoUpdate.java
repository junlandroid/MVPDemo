...
//        AlertDialog.Builder builder =  new AlertDialog.Builder(JUNLApplication.getContext());

//        AlertDialog.Builder alert = new AlertDialog.Builder(JUNLApplication.getContext())
//                .setTitle("新版本").setIcon(R.mipmap.ic_launcher);
//                .set
