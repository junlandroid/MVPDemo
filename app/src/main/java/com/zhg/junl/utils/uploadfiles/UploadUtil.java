//package com.zhg.junl.utils.uploadfiles;
//
...
//
//import com.android.industy2.upload.CustomMultipartEntity.ProgressListener;
//
///**
// *
// * 上传工具类
...
// *         QQ: 840950105<br>
// *         支持上传文件和参数
// * @see http://blog.csdn.net/springsky_/article/details/8213898
// */
...
//					@Override
//					public void run() {
//						string = toUploadFile(file, fileKey, RequestURL, param);
//					}
//				}).start();
//		return string;
//
...
//		// 添加文件参数
//		if (file != null && file[i].exists()) {
//			entity.addPart(fileKey, new FileBody(file[i]));
//		}
//		totalSize = entity.getContentLength();
//
//		post.setEntity(entity);
