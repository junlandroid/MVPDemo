 ...
 * @author junl
 * @since 2016-11-1
 * @see http://blog.csdn.net/kesenhoo/article/details/6996834
 */
public class MyLogger {
	private final static boolean                logFlag         = true;//日志的开关  
    
    public final static String                  tag             = "Industrial";  
    ...
    private static final String                 GUJUNHUA           = "@gujunhua@";//log用户名称  
